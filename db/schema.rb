...
ActiveRecord::Schema.define(version: 2022_07_19_052136) do
  ...
  create_table "blog_tags", charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
    t.integer "blog_id"
    t.integer "tag_id"
  ...
  create_table "hobbies", charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
    t.string "name"
    t.integer "user_id"
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
